        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <tbody>
                  <tr className="border-b border-gray-100 hover:bg-kyoto-cream/30">
                    ...
                    <td className="py-2 px-3 text-center">
                      <span className="inline-block border-2 border-kyoto-gold/40 bg-kyoto-cream/30 px-2 py-1 rounded-sm font-bold text-kyoto-dark-green text-lg">
                        66,000円
                      </span>
                    </td>
          ...
          <div className="space-y-3 flex flex-col justify-between">
            ...
            >
              ...
              {/* PC表示時は横並び、モバイル表示時は縦並び */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                <div className="flex items-center">
                  <span className="text-gray-700 text-base mr-2 w-20">会員：</span>
                  <span className="inline-block border-2 border-kyoto-gold/40 bg-kyoto-cream/30 px-2 py-1 rounded-sm font-bold text-kyoto-dark-green text-lg">
                    500円/日
                  </span>
                </div>
                <div className="flex items-center">
                  <span className="text-gray-700 text-base mr-2 w-20">ビジター：</span>
                  <span className="inline-block border-2 border-kyoto-gold/40 bg-kyoto-cream/30 px-2 py-1 rounded-sm font-bold text-kyoto-dark-green text-lg">
                    1,500円/日
                  </span>
                </div>
            ...
            <div 
              ...
              className="bg-white rounded-sm shadow-lg p-3 opacity-0"
            >
            ...
            >
              ...
              <div className="bg-kyoto-cream/30 p-3 rounded">
                <p className="border-2 border-kyoto-gold/40 bg-white/50 px-2 py-1 rounded-sm inline-block font-bold text-kyoto-dark-green text-lg mb-1">
