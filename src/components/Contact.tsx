...
const ContactInfo = ({ icon, title, children }) => {
  return (
    <div className="flex items-start">
      ...
      <div>
        <h4 className="font-medium text-kyoto-white mb-1">{title}</h4>
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-kyoto-dark-green" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-kyoto-white/80 max-w-2xl mx-auto mt-6">
            新しい仲間と一緒に、まずは体験から。<br />
            新会員も募集中。お気軽にお問い合わせください。
          </p>
        </div>
