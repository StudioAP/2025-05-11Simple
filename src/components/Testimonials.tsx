...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-12 bg-kyoto-dark-green" ref={sectionRef}>
      <div className="section-container max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div 
          ref={testimonialRef}
          className="bg-white/10 backdrop-blur-sm p-6 rounded-sm border border-kyoto-gold/30 max-w-xl mx-auto opacity-0"
        >
          <div className="mb-4">
            <svg className="w-8 h-8 text-kyoto-gold/50" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
          ...
          <blockquote className="text-base md:text-lg text-white italic leading-relaxed mb-4">
            市のコートは予約が大変。でもここなら、思い立った時にプレーできる。自然に囲まれて、毎回スッキリ！
          </blockquote>
          
          <div className="flex items-center">
            <div className="h-10 w-10 rounded-full bg-kyoto-gold overflow-hidden mr-3">
              <img 
            ...
            <div>
              <p className="text-kyoto-gold font-bold text-sm">京都ローンテニスクラブ会員</p>
              <p className="text-white/70 text-xs">10年以上のメンバー</p>
            </div>
          </div>
        </div>
      </div>
